...
public class Main {
        public static void main(String[] args) {
                ...
                System.out.println("Name: " + dog2 + ", Fur Color: " + dog2.furColor + ", Born: " + dog2.birthYear
                                + ", Age: "
                                + dog2.age(currentYear));
                // Creates new object: dog3
                Dog dog3 = new Dog("Brown", "Berry", 2024);
                // Prints atrributes of dog3
                System.out.println("Name: " + dog3 + ", Fur Color: " + dog3.furColor + ", Born: " + dog3.birthYear
                                + ", Age: "
                                + dog3.age(currentYear));

                // Creates new object: gs1
                GermanShepherd gs1 = new GermanShepherd("Black & Gray", "Rocky", 2006, args, false);
                // Prints atrributes of gs1
                System.out.println(
                                "Name: " + gs1 + ", Fur Color: " + gs1.furColor + ", Born: " + gs1.birthYear + ", Age: "
                                                + gs1.age(currentYear));
